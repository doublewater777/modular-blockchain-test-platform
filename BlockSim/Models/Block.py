class Block(object):
    ...
    def __init__(self,
	 ...
	 miner=None,
	 transactions=[],
	 size=1.0,transCreateTime=0,transExeTime=0,BlockExeTime=0,mkRoot=0):
        ...
        self.size = size
        self.transCreateTime=transCreateTime
        self.transExeTime=transExeTime
        self.BlockExeTime=BlockExeTime
        self.mkRoot=mkRoot